...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/22 10:29:22 by temil-da          #+#    #+#             */
/*   Updated: 2024/05/24 15:53:24 by temil-da         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_put_logo_2(void)
{
	...
	ft_printf("--' '--'  \033[37m\n                                   ");
	ft_printf("                             \033[31m-BONUS EDITION 👹\033[0m\n");
}

void	print_character(char *output, int *i, int temp_pid)
{
	if (*output != '\0')
		write(1, output, 1);
	else
...
void	handle_signals_mini(int signal, siginfo_t *siginfo, void *context)
{
	...
	if (i == 8)
		print_character(&output, &i, temp_pid);
}
